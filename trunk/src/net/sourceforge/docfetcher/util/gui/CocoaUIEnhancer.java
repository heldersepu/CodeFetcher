 ...
 * 
 * @see <a href="http://www.transparentech.com/opensource/cocoauienhancer">Source</a>
 */
public class CocoaUIEnhancer {
    ...
    private static class MenuHookObject {
        final Runnable about;
        final Runnable pref;

        public MenuHookObject( Runnable about, Runnable pref ) {
            this.about = about;
            this.pref = pref;
        }
     ...
     */
    public void hookApplicationMenu( Display display, Listener quitListener, Runnable aboutAction,
    		Runnable preferencesAction ) {
